...
public class FrmEvaluator implements AbsVisitor {
	...
	private boolean isAnyCall = false;
	...
	public void visit(AbsProgram acceptor) {
		...
		//TODO: Pregledat statements in poiskat vse klice in doloèimo max! Prireditvenih stavkov ne 
		// gledamo in dostopov do spremenljivk!
		argSize = 0;
		isAnyCall = false;
		acceptor.stmt.accept(this);
	}
