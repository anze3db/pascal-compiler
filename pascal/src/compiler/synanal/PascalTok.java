...
public class PascalTok {
  ...
  /* non terminals */
  static final int record_list = 26;
  static final int value_params = 22;
  static final int statement = 6;
  static final int value_list = 21;
  static final int constant = 8;
  static final int if_statement = 29;
  static final int type = 23;
  static final int pf_declarations = 18;
  static final int while_statement = 33;
  static final int parms = 15;
  static final int parameters = 13;
  static final int list_statement2 = 32;
  static final int record_type = 25;
  static final int constant_declarations = 2;
  static final int for_statement = 34;
  static final int types = 9;
  static final int assign_statement = 28;
  static final int subprogram_declarations = 5;
  static final int multiple_statement = 30;
  static final int vars = 11;
  static final int type_declaration = 10;
  static final int source = 0;
  static final int value = 20;
  static final int function_head = 19;
  static final int table_type = 24;
  static final int list_statement = 31;
  static final int ptr_type = 27;
  static final int program_indication = 1;
  static final int procedure_head = 17;
  static final int parm = 16;
  static final int variable_declarations = 4;
  static final int var = 12;
  static final int parameters_list = 14;
