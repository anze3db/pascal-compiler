...
public class PascalTok {
  ...
  /* non terminals */
  static final int value_params = 24;
  static final int statement = 15;
  static final int value_list = 23;
  static final int constant = 20;
  static final int if_statement = 16;
  static final int type = 25;
  static final int while_statement = 17;
  static final int list_statement2 = 31;
  static final int record_type = 28;
  static final int constant_declarations = 5;
  static final int for_statement = 18;
  static final int types = 10;
  static final int assign_statement = 19;
  static final int sub_vars = 13;
  static final int subprogram_declarations = 9;
  static final int multiple_statement = 29;
  static final int vars = 12;
  static final int type_declaration = 21;
  static final int source = 0;
  static final int value = 22;
  static final int table_type = 27;
  static final int subprogram_head = 14;
  static final int list_statement = 30;
  static final int ptr_type = 26;
  static final int program_indication = 1;
  static final int variable_declarations = 8;
  static final int param_descr_list_r = 3;
  static final int comp_descr_list = 2;
  static final int param_descr_list = 4;
  static final int sub_variable_declarations = 7;
  static final int type_declarations = 6;
  static final int constants = 11;
}
