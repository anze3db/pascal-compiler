...
public class PascalTok {
  ...
  /* non terminals */
  static final int value_params = 23;
  static final int statement = 13;
  static final int value_list = 22;
  static final int constant = 19;
  static final int if_statement = 14;
  static final int type = 24;
  static final int while_statement = 15;
  static final int list_statement2 = 30;
  static final int record_type = 27;
  static final int constant_declarations = 5;
  static final int for_statement = 17;
  static final int types = 9;
  static final int assign_statement = 18;
  static final int subprogram_declarations = 8;
  static final int multiple_statement = 28;
  static final int vars = 11;
  static final int type_declaration = 20;
  static final int source = 0;
  static final int value = 21;
  static final int table_type = 26;
  static final int subprogram_head = 12;
  static final int list_statement = 29;
  static final int ptr_type = 25;
  static final int program_indication = 1;
  static final int repeatuntil_statement = 16;
